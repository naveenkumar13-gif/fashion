...
function HeaderContent(){
  return(
    ...
    <h1 className='text-[4rem] font-extrabold leading-normal max-lg:text-[3rem] max-md:text-center  '  >
        <p className='bg-white w-[40%] pl-4 max-md:text-[2.5rem] max-sm:w-[80%] max-md:w-[50%]  max-md:m-auto max-sm:m-auto'  data-aos='fade-right'  data-aos-duration={1200} data-aos-delay={1000} >LET’S</p>
